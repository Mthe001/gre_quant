...
// const generateSections = (count: number, prefix: string): Section[] => {
//   return Array.from({ length: count }, (_, i) => {
//     const number = i + 1;
//     const difficulty =
//       i % 3 === 0 ? "Medium" : i % 3 === 1 ? "Hard" : "Research";
//     const color =
//       difficulty === "Medium"
//         ? "blue"
//         : difficulty === "Hard"
...
// const sprintSections = generateSections(24, "sprint");
// const specialSections = generateSections(6, "special");
// const puzzleSections = generateSections(16, "puzzle");
...
//   // Filter sections based on search term and difficulty
...
//   const filteredSprintSections = sprintSections.filter(filterSection);
//   const filteredSpecialSections = specialSections.filter(filterSection);
//   const filteredPuzzleSections = puzzleSections.filter(filterSection);

//   // Check if we have any results
//   const hasResults =
//     filteredSprintSections.length > 0 ||
//     filteredSpecialSections.length > 0 ||
//     filteredPuzzleSections.length > 0;
...
//           {/* Search bar - left on lg screens, full width on smaller screens */}
...
//           {/* Filter tabs - right on lg screens, centered on smaller screens */}
...
//         {/* Math Sprint Practice */}
//         {filteredSprintSections.length > 0 && (
//           <section className="space-y-6 animate-fade-in">
//             <SectionHeader
//               title="Math Sprint Practice"
//               subtitle="KMF Quant Questions"
//             />

//             <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
//               {filteredSprintSections.map((section, i) => (
//                 <SectionCard
//                   key={section.id}
...
//                   category={section.id.split("-")[0]} // Extract category from id (e.g., "sprint")
//                 />
//               ))}
//             </div>
//           </section>
...
//               {filteredSpecialSections.map((section, i) => (
//                 <SectionCard
//                   key={section.id}
//                   number={section.number}
//                   difficulty={section.difficulty}
...
//                   description={section.description}
//                   animationDelay={i * 0.05}
//                   category={section.id.split("-")[0]} // Extract category from id (e.g., "special")
//                   large
//                 />
//               ))}
//             </div>
...
//           >
//             <SectionHeader
//               title="Math Latest Puzzles"
//               subtitle="KMF Quant Questions"
//             />

//             <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
//               {filteredPuzzleSections.map((section, i) => (
//                 <SectionCard
//                   key={section.id}
//                   number={section.number}
//                   difficulty={section.difficulty}
...
//                   description={section.description}
//                   animationDelay={i * 0.05}
//                   category={section.id.split("-")[0]} // Extract category from id (e.g., "puzzle")
//                 />
//               ))}
//             </div>
//           </section>
